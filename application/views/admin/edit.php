         ...
         <div class="col-md-6">
            ...
            <div class="box box-primary">
               <div class="box-header with-border">
                  <h3 class="box-title">Editar nueva categoría </h3>
               </div>
               <!-- /.box-header -->
               <!-- form start -->
               <?php 
            ...
            <div class="box-body">
               ...
               <div class="form-group">
                  ...
                  <textarea class="form-control" rows="3" name="descripcion" id="descripcion" value="<?php echo $datos->descripcion ?>"></textarea>
               </div>
            </div>
            <!-- /.box-body -->
