         ...
         <div class="col-md-6">
            ...
            <div class="box box-primary">
               <div class="box-header with-border">
                  <h3 class="box-title">Editar Información Usuario</h3>
               </div>
               <!-- /.box-header -->
               <!-- form start -->
               <?php 
            ...
            <div class="box-body">
               ...
               <div class="form-group">
                  <label for="exampleInputname">Nueva contraseña</label>
                  <input type="password" class="form-control" name="password">
               </div>
               
               <div class="form-group">
                  <label for="exampleInputname">Rol</label>                  
                  <select name="rol" id="rol" class="form-control">
                     <?php foreach($roles as $rol):?>
                        <option value="<?php echo $rol->id;?>" <?php echo $rol->id == $usuario->privilegio ? "selected":"";?>><?php echo $rol->nombre;?></option>
                    <?php endforeach;?>
