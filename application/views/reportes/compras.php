      ...
      <div class="box box-solid">
         <div class="box-body">
            <div class="row">
               ...
               <div class="col-md-4">
                  <input type="submit" name="buscar" value="Buscar" class="btn btn-primary" onclick=this.form.action="compras">
                  <input type="submit" name="Excel" value="Excel" class="btn btn-success" onclick=this.form.action="excelCompras">
