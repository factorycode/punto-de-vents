...
<head>
  ...
  <!-- se enlaza jquery en este linck -->
  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="#" class="logo">
        ...
        <span class="logo-lg"><b>Uniformes</b></span>
      </a>
        ...
        <div class="navbar-custom-menu">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="<?php echo base_url();?>assets/#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs"><?php echo $this->session->userdata('nombre'); ?>  <?php echo $this->session->userdata('apellido_m'); ?></span>
            </a>
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <li class="user-footer">
                  <div class="pull-right">
                    <a href="<?php echo base_url();?>login/salir" class="btn btn-default btn-flat">cerrar session</a>
                  </div>
                </li>
              </ul>
            </li>
